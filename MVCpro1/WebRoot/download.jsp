	...
	<body>
		...
		<div id="maindiv">
			<ul>
				...
				<a id="downloadLink" href="DownloadController?id=${download.id}" title="等待下载">下载</a>
				</div>
				</li>
			</ul>
		</div>
		...
		<div id="footer">
			<div id="side">
				...
				<a id="tuichu" href="out" title="退出">退出</a>
			</div>
			<div id="main">
				
				<a id="mainpage" href="/login/main.jsp" title="主页面">主页面</a>
